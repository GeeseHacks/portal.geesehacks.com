        ...
        <div className="bg-gray-900 text-white flex flex-col justify-center items-start w-full sm:w-1/2 min-w-[300px] px-8 sm:px-12 lg:px-24 xl:px-40 2xl:px-[13%]">
          ...
          >
            ...
            {passwordErrors.length > 0 && (
              <ul className="text-red-500 text-sm mt-2 list-disc list-inside" role="alert">
            ...
            />
            {verifyPasswordError && (
              <p className="text-red-500 text-sm mt-2" role="alert">{verifyPasswordError}</p>
            )}
            <button
              type="submit"
          ...
          <div className="flex w-full">
            <p className="mt-4 text-gray-400 text-center text-sm w-full">
              ...
              <Link href="/login" className="text-blue-400" aria-label="login">
                Log in
              </Link>
            </p>
          </div>
