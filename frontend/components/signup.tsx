    ...
    return (
        <div className="flex h-screen">
            <div className="bg-gray-900 text-white flex flex-col justify-center items-start w-1/2 min-w-[300px] px-6"> {/* Changed items-center to items-start */}
                ...
                <p className="mt-2 mb-6 text-left">Make an account with us to continue!</p>
                ...
                <form className="flex flex-col gap-4 w-full">
                    ...
                    <p>Verify Password</p>
                    <input type="password" name="verify-password" placeholder="Verify your password" required className="p-2 rounded bg-gray-800 text-white" />
                    <button type="submit" className="bg-black text-white py-2 rounded">Sign In</button>
                </form>
            </div>
